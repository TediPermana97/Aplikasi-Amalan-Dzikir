...
import com.tedystoreapp.ayatulkhirzialfatahtemboronewapp.Adafter.AdafterSlideYasin;
...
public class SurahyasinActivity extends AppCompatActivity {

    private ViewPager mSlideViewPager;
    private LinearLayout mDotLayout;
    private AdafterSlideYasin sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surahyasin);
        ...
        sliderAdapter = new AdafterSlideYasin(SurahyasinActivity.this);
    ...
    public void addDotsIndicator(int posistion){
        ...
        for (int i = 0;i <mDots.length;i++){
            mDots[i] = new TextView(SurahyasinActivity.this);
